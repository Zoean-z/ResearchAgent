...
_EXPORTS = {
    ...
    "ArxivPaperDescriptor": ("research_agent.tools.protocol", "ArxivPaperDescriptor"),
    ...
    "SearchArxivInput": ("research_agent.tools.protocol", "SearchArxivInput"),
    ...
    "ImportArxivPaperInput": ("research_agent.tools.protocol", "ImportArxivPaperInput"),
    ...
    "SearchArxivOutput": ("research_agent.tools.protocol", "SearchArxivOutput"),
    ...
    "ImportedPaperSummaryDescriptor": ("research_agent.tools.protocol", "ImportedPaperSummaryDescriptor"),
    "ImportArxivPaperOutput": ("research_agent.tools.protocol", "ImportArxivPaperOutput"),
    # protocol envelopes
